...
main: 
        ...
        LDR     r9, =0x20               @ tamanho da sequencia 

        RSB     r7, r9, #32             @ r7 = 32 - r9
        MOV     r0, r0, LSL r7          @ shift left de (32-r9) bits

primeiro:
        BL      inicio_estado           @ vai para inicio_estado
...
quarto:
        ...
        CMP     r3, #1                  @ compara r3 com 1
        ADDEQ   r2, r2, #1              @ se r3 = 1, atingiu a sequencia, coloca 1 na saida
        BEQ     segundo                 @ se r3 = 1, volta para segundo estado
